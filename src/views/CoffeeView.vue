          ...
          <div class="row">
            ...
            <div class="col-md-6 d-flex align-items-center course-desc wow">
              <div class="">
                ...
                <h5><b>Treino de percepção sensorial</b></h5>
                ...
                <h5><b>Degustação prática/teórica</b></h5>
                ...
                <h6>- Ser avisado antes na divulgação dos próximos cursos</h6>
...
export default {
  ...
  methods: {
    ...
    submitForm(event) {
      ...
      let whatsText =
        `*Olá! Gostaria de me inscrever no seu curso de Introdução à Classificação e Degustação de Cafés Especiais.*\n` +
        `\n` +
        `🪪 *Nome:* ${formData.name}\n` +
