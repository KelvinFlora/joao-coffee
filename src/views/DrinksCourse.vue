  ...
  <div class="container">
    <div>
      <div class="text-center title-course1 pt-5">
        <h2><b>Curso de Barista - Drinks Caseiros (Especial de Dia das Mães)</b></h2>
      </div>
      <div class="container">
        <div class="card mb-3 rounded-start wow">
          <div class="row">
            ...
            <div class="col-md-6 d-flex align-items-center course-desc wow">
              <div class="">
                <h4 class="card-title">Seguem as informações do curso de barista:</h4>
                <h6>Dia: 11 de maio</h6>
                <h6>Horário: 08:00 às 12:00</h6>
                <h6>
                ...
                <h6>As vagas são limitadas, então dê este presente para sua mãe.</h6>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="paymentMethod === 'credito' || showInstallments" class="row mb-3">
          <div class="col-12">
            ...
            <select class="form-select" v-model="installments">
              <option v-for="n in 2" :value="n" :key="n">
                {{ n }}x de R$ {{ (199.9 / n).toFixed(2) }}
              </option>
            </select>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    submitForm(event) {
      ...
      const total = 199.9; // Valor total do curso
      ...
      let whatsText =
        `*Olá! Gostaria de me inscrever no seu Curso de Barista - Drinks Caseiros (Especial de Dia das Mães).*\n` +
        `\n` +
        `🪪 *Nome:* ${formData.name}\n` +
